...
class UserTest < ActionDispatch::IntegrationTest
  ...
  module BrowsingTestDSL
    ...
    def creates_user_account(parameters)
      ...
      assert_equal User.last.name, user_name
    ...
    def edits_user_account(user_account, parameters)
      ...
      assert_equal flash[:notice], "La cuenta #{user_name} ha sido correctamente actualizada."
      assert_select 'div#notice', "La cuenta #{user_name} ha sido correctamente actualizada."
